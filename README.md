...
*   There are known issues with GTK4 and Broadway that can't be fixed by this image, use the GTK3 image if these bother you:
    ...
    *   No clipboard management (copy/paste from out->in or in->out of the image won't work) — this is an upstream issue with no official fix yet
        ...
        *   This is also true for the GTK3 images and cannot be addressed there
